...
User.create!([
  {name: "Adi", email: "adi@example.com", password: "secret", admin: true},
  {name: "Aki", email: "aki@example.com", password: "secret"},
  {name: "Ned", email: "ned@example.com", password: "secret"},
  {name: "San", email: "san@example.com", password: "secret"}
])


Category.create(:name => 'Free Food')
Category.create(:name => 'Rails')
Category.create(:name => 'Ruby')
Category.create(:name => 'Things That Fly')
